...
{
echo "<tr><td><form action='index.php' method='post'><input type='hidden' name='sum' value='53'></td><td>" . $row['name'] . "</td><td><table><input type='hidden' name='ocid' value='" . $row['id'] . "'><input type='text' name='ocupdate' value='" . $row['order'] . "' maxlength='2' size='3'/></table></td><td><table><input type='submit' name='ocorder' value='Edit'></table></form></td></tr>";
}
