...
{
$check3 = mysql_query("SELECT * FROM `articles` WHERE `name` LIKE '%' ORDER BY `id` DESC")or die("<br>Error Code 352: Please contact the Root Administrator immediately.<br>" . mysql_error());
$count = mysql_numrows($check3);
if ($count == 0)
{
echo "<br>Error Code 74: No articles.<br>
...
{
$check4 = mysql_query("SELECT * FROM `acat` WHERE `id` = " . $aedit['cat'])or die("<br>Error Code 353: Please contact the Root Administrator immediately.<br>" . mysql_error());
