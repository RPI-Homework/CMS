...
{
$check3 = mysql_query("SELECT * FROM `memberskin` WHERE `skin` = '" . $_GET['add'] . "'")or die("<br>Error Code 548: Please contact the Root Administrator immediately.<br>" . mysql_error());
$num2 = mysql_num_rows($check3);
if ($num2 != 0)
{
echo "<br>Error Code 145: A skin with that name already exists.<br>
...
<input type='hidden' name='sum' value='92' />";
...
<textarea rows='3' cols='75' name='eachlink'></textarea><br>
[Menu Links]
<br>
<textarea rows='3' cols='75' name='posteachlink'></textarea><br>
