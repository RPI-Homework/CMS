...
{
$check3 = mysql_query("SELECT * FROM `adminskin` WHERE `id` = " . $_GET['id'])or die("<br>Error Code 536: Please contact the Root Administrator immediately.<br>" . mysql_error());
$num2 = mysql_num_rows($check3);
if ($num2 == 0)
{
echo "<br>Error Code 140: Invalid skin ID.<br>
...
<input type='hidden' name='sum' value='93' />";
...
[Menu Links]
<br>
<textarea rows='3' cols='75' name='betlinks'>" . $sedit['betlinks'] . "</textarea><br>
[Menu Links]
<br>
